<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QR_PrestamoOtrasInstitu.aspx.vb" Inherits="Bodega_WebApp.QR_PrestamoOtrasInstitu" %>
...
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="700px">
            <LocalReport ReportPath="generadorQR/Despachos/PrestamoOtrasInstituciones/QR_PrestamoOtrasInstitu.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="Bodega_WebApp.dsQR_PrestamoOtrasInstituTableAdapters.PRO_QR_DESPA_PRESTAMO_INSTITUCIONES_NET2014TableAdapter" 
