<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QR_PorCanje.aspx.vb" 
Inherits="Bodega_WebApp.QR_PorCanje" %>
...
<head id="Head1" runat="server">
    <title>Reporte Despacho X Canje</title>
</head>
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="700px">
            <LocalReport ReportPath="generadorQR/Despachos/PorCanje/QR_PorCanje.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="Bodega_WebApp.dsQR_DespaXCanjeTableAdapters.PRO_QR_RECEPXCANJE_NET2014TableAdapter" 
