Public Class QR_XDevolucionDePrestamo1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ObjectDataSource1.SelectParameters(4).DefaultValue = Request.QueryString("anioDevolucion")
        ObjectDataSource1.SelectParameters(5).DefaultValue = Request.QueryString("NumDevolucion")
        ObjectDataSource1.SelectParameters(6).DefaultValue = Request.QueryString("Proveedor")
