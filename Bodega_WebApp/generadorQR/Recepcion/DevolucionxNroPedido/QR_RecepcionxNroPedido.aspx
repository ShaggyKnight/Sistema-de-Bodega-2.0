<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QR_RecepcionxNroPedido.aspx.vb" Inherits="Bodega_WebApp.QR_RecepcionxNroPedido" %>
...
<head id="Head1" runat="server">
    <title>CodigosQRMateriales_Desde_Proveedores</title>
</head>
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="700px">
            <LocalReport ReportPath="generadorQR/Recepcion/DevolucionxNroPedido/QR_DevolxNroPedido.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="Bodega_WebApp.dsQR_DevolucionxNroPedidoTableAdapters.PRO_QR_DETMOVIMIENTOS_MATERIALESXNROPEDIDO_NEW2015TableAdapter" 
