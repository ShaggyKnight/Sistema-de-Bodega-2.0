<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QR_DevolXUsuario.aspx.vb" Inherits="Bodega_WebApp.QR_DevolXUsuario" %>
...
<head id="Head1" runat="server">
    <title>CodigosQRMateriales</title>
</head>
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="700px">
            <LocalReport ReportPath="generadorQR/Recepcion/DevolucionxUsuario/QR_DevolucionXUsuario.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="Bodega_WebApp.dsQR_DevolucionXUsuarioTableAdapters.PRO_QR_DETMOVIMIENTOS_DEVOLUCIONUSUSARIOS_NEW2015TableAdapter" 
