<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QR_RecepcionXCanje.aspx.vb" 
Inherits="Bodega_WebApp.QR_RecepcionXCanje" %>
...
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="700px">
            <LocalReport ReportPath="generadorQR/Recepcion/RecepcionXCanje/QR_RecepcionXCanje2.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="Bodega_WebApp.dsQR_RecepcionXCanjeTableAdapters.PRO_QR_RECEPXCANJE_NET2014TableAdapter" 
