    <%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QR_RecepcionxDonacion.aspx.vb" 
Inherits="Bodega_WebApp.QR_RecepcionxDonacion" %>
...
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="700px">
            <LocalReport ReportPath="generadorQR/Recepcion/RecepcionxDonacion/QR_RecepXDonacion2.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="Bodega_WebApp.dsQR_RecepXDonacionTableAdapters.PRO_QR_DETMOVIMIENTOS_ORDENCOMPRA_NET2014TableAdapter" 
