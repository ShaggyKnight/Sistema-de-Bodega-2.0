<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Rpt_AjusteExistencia_viewAjuste.aspx.vb" Inherits="Bodega_WebApp.Rpt_AjusteExistencia_viewAjuste" %>
...
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="850px">
            <LocalReport ReportPath="reportes/Reportes/AjusteExistencias/RPT_AjusteExistencia.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="Bodega_WebApp.dsRPT_AjusteExistTableAdapters.PRO_RPT_AJUSTE_MATERIALES_net2015TableAdapter" 
