<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report_InveXItem.aspx.vb" 
Inherits="Bodega_WebApp.Report_InveXItem" %>
...
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="700px">
            <LocalReport ReportPath="reportes/Reportes/Inventario/InventarioXItem/XDetalle/RPT_InveXItem.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="Bodega_WebApp.dsRPT_InveXItemTableAdapters.PRO_RPT_INVENTARIOXITEM_NET2014TableAdapter" 
