<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RptVentana_xCanje.aspx.vb" Inherits="Bodega_WebApp.RptVentana_xCanje" %>
...
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="700px">
            <LocalReport ReportPath="reportes/Recepciones/RecepXCanje/z">
                <DataSources>
