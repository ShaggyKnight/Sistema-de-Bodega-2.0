<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RptVentana_xDonacion.aspx.vb" Inherits="Bodega_WebApp.RptVentana_xDonacion" %>
...
<head id="Head1" runat="server">
    <title>Reporte Recepcion x Donación</title>
</head>
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="700px">
            <LocalReport ReportPath="reportes/Recepciones/xDonacion/RPT_xDonacion.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="Bodega_WebApp.dsRPT_xDonacionTableAdapters.PRO_INFORME_TRANSACCIONES_SEL_netTableAdapter" 
