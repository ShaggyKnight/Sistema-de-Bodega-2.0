<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RptVentana_DespXCanje.aspx.vb" Inherits="Bodega_WebApp.RptVentana_DespXCanje" %>
...
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="700px">
            <LocalReport ReportPath="reportes/Despachos/DespXCanje/RPT_DespPorCanje.rdlc">
                <DataSources>
