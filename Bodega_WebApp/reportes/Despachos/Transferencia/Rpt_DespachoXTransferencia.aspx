<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Rpt_DespachoXTransferencia.aspx.vb" Inherits="Bodega_WebApp.Rpt_DespachoXTransferencia" %>
...
<head id="Head1" runat="server">
    <title>INFORME_DESPACHO_TRANSFERENCIA</title>
</head>
<body onload="load()">
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="800px">
            <LocalReport ReportPath="reportes/Despachos/Transferencia/RPT_DespaTransferencia.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="Bodega_WebApp.dsRpt_DespachoAUsuariosTableAdapters.PRO_INFORME_TRANSACCIONES_SEL_netTableAdapter" 
