Public Class historialArticulos_XDevolucionDePrestamo
    ...
    Public Sub New(codigo As String, nombre As String, cantidad As String, CantDevulto As String, descripcion As String, neto As String,
        ...
        Me.FLD_CANTADEVOLVER = CantDevulto
