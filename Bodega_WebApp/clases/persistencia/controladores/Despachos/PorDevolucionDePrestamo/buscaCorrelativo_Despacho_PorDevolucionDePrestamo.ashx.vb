...
Public Class buscaCorrelativo_Despacho_PorDevolucionDePrestamo
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        articulo = ControladorPersistencia.buscaCorrelativo_Despacho_PorDevolucionDePrestamo(fecha, Ncorrelativo, CodMaterial)
