...
Public Class getHistorial_DetalleTemp_PorDevoDePrestamo
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        retorno = ControladorPersistencia.getHistorial_DetalleTemp_PorDevoDePrestamo(codigo, bodega, correlativo)
