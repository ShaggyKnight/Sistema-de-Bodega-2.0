...
Public Class saveDetalleMovimiento_PorDevoluDePrestamo
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        ControladorPersistencia.saveDetalleMovimiento_PorDevoluDePrestamo(fechaNueva, NCorrelativoNuevo, CodigoTrasaccionNuevo, fechaAntiguo, NCorrelativoAntiguo)
