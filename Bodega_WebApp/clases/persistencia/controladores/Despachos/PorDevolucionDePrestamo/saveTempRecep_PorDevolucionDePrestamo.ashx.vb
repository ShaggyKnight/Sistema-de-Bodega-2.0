...
Public Class saveTempRecep_PorDevolucionDePrestamo
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        ControladorPersistencia.saveTempRecep_PorDevolucionDePrestamo(cont, NumeroDonacionArticulo, fecha, NumeroCorrelativo,
