...
Public Class savePrestamoDespOtrasInstituciones
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        ControladorPersistencia.savePrestamoDespOtrasInstituciones(fecha, NumeroDonacionArticulo, Ncorrelativo, fechaCompleta,
