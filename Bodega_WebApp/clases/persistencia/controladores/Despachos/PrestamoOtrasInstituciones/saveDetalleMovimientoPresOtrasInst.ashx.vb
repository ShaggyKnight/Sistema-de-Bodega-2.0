...
Public Class saveDetalleMovimientoPresOtrasInst
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        ControladorPersistencia.saveDetalleMovimientoOtrasInst(fecha, NumeroCorrelativo)
        ...
        'Dim cantPedida As String = context.Request("CantPedida")
        'Dim cantDevolver As String = context.Request("null2")
        'Dim cantPendiente As String = context.Request("null3")
        ...
        'ControladorPersistencia.saveDetalleMovimientoOtrasInst(cont, NumeroDonacionArticulo, fecha, NumeroCorrelativo,
        '                                       CantidadMovimiento, dbodega, CodigoMaterial,
        '                                       ItemMaterial, cantPedida, cantDevolver, cantPendiente, PrecioUnitario, loteSerie, fechaVencimiento)
        'respuesta.Add("item", "done")
