...
Public Class saveTempOtrasInstituciones
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        ControladorPersistencia.saveDetalleMovimientoOtrasInst_DetalleTemp(cont, NumeroDonacionArticulo, fecha, NumeroCorrelativo,
