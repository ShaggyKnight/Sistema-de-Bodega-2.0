...
Public Class getHistorialTempDetalleProductosDespOtrasInst
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        retorno = ControladorPersistencia.getHistoricoTEMPDetalleProductosOrderFechaDOInst(codigo, bodega, correlativo)
