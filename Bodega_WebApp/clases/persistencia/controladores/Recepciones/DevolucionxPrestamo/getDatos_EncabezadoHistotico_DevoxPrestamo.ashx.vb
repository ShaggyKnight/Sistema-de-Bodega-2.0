...
Public Class getDatos_EncabezadoHistotico_DevoxPrestamo
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        EncabezadoDevolucion = ControladorPersistencia.getDatos_EncabezadoHistotico_DevoxPrestamo(CodigoTrasaccionNuevo, CodigoTrasaccionAntiguo, fechaPrestamo, NcorrelativoAntiguo_Prestamo)
