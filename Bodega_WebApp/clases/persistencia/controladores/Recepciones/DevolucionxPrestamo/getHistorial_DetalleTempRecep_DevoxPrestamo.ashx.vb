...
Public Class getHistorial_DetalleTempRecep_DevoxPrestamo
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim retorno As ListaDetalleArticulos_DevolucionxPrestamo

        retorno = ControladorPersistencia.getHistorial_DetalleTempRecep_DevoxPrestamo(codigo, bodega, correlativo)
