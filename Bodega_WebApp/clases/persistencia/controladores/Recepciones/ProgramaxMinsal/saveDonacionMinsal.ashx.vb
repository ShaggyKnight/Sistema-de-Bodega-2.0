...
Public Class saveDonacionMinsal
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim programa As String = context.Request("programa")

        Dim respuesta As New Dictionary(Of String, String)

        ControladorPersistencia.saveDonacionMinsal(fecha, NumeroDonacionArticulo, Ncorrelativo, fechaCompleta,
                                               descripcion, valor, numeroDoc, programa)
