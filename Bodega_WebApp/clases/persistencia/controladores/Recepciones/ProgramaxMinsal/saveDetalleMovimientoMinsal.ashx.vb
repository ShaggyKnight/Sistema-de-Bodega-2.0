...
Public Class saveDetalleMovimientoMinsal
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim CodigoProgramaMinsal As String = context.Request("programaMinsal")
        ...
        ControladorPersistencia.saveDetalleMovimientoMinsal(cont, CodigoProgramaMinsal, fecha, NumeroCorrelativo,
