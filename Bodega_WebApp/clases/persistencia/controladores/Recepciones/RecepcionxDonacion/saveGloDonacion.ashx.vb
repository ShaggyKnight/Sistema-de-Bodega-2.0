...
Public Class saveGloDonacion
    ...
    Public Function crearRecepcionDonacion(ByVal context As HttpContext)
        ...
        Dim Periodo As String = context.Request("dataFormDonacion[anioDonacion]")
        ...
        ' Graba Donación
        Dim fechaCompleta As String = context.Request("dataFormDonacion[fechaServidor]")
        Dim descripcion As String = UCase(context.Request("dataFormDonacion[descripcion]"))
        ...
        estado = ControladorPersistencia.saveGeneralDonacion(usuario.username, Periodo, NroDonacionArticulo, fechaCompleta, descripcion, valor, NroDocumento)
