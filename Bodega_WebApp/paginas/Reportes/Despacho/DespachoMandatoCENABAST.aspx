...
CodeBehind="DespachoMandatoCENABAST.aspx.vb" Inherits="Bodega_WebApp.DespachoMandatoCENABAST" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <%  CType(Me.Page.Master, Bodega_WebApp.Site).idePagina = Bodega_WebApp.Pagina.reportMandatoCENABAST%>
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">

    <div id="form" style="margin-bottom:8px; height: 208px; width: 54%; margin-left: 20%; margin-top: 10px;">
    </div>
    ...
    <script type="text/javascript">
        ...
        */
        ...
        $('#form').w2form({
            ...
            header: 'Despacho v/s Mandato CENABAST',
            formHTML:
                '<div id="form" style="width: 780px;">' +
	               '<div class="w2ui-page page-0">' +
			        ...
			        '<div class="w2ui-group" style="height: 116px;">' +
                ...
                "imprimir": function () {
                    ...
                    if (fechaInicio && fechaTermino) {
                        ...
                        if (bodega) {
                            ...
                            window.open('../../../reportes/Reportes/Despacho/DespachoMandatoCENABAST/Report_DespaMandatoCENABAST.aspx?FechaInicio=' + fechaInicio + '&FechaTermino=' + fechaTermino + '&Bodega=' + bodega + '&CentroCosto=' + '%');

                        } else {
                            alert("Error, Se debe definir la BODEGA")
