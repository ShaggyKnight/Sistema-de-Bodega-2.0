...
CodeBehind="ProgramaDeCompra.aspx.vb" Inherits="Bodega_WebApp.ProgramaDeCompra" %>


<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <%  CType(Me.Page.Master, Bodega_WebApp.Site).idePagina = Bodega_WebApp.Pagina.reportProgramaDeCompra%>
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="form2" style="height: 52px; width: 60%; margin-left: 20%; background-color: rgb(245, 246, 247);"></div>
            ...
            actions: {
                ...
                "imprimir": function () {
                    ...
                    if (bodega) {
                        ...
                        window.open('../../../reportes/Reportes/ConsumoMensual/ProgramaCompra/Report_ProgramaCompra.aspx?Bodega='+ bodega );
